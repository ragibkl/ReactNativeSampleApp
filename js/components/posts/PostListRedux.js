...
import { loadPosts, clearPosts } from '../../actions/post'
import { apiFetch } from '../../utils/apiUtils'

class PostListRedux extends Component {
  handleOnPressFetch () {
    const url = 'https://jsonplaceholder.typicode.com/posts'
    apiFetch(url).then((data) => this.props.onLoadPosts(data))
  }
  handleOnPressClear () {
...
export default connect(mapStateToProps, mapDispatchToProps)(PostListRedux)
